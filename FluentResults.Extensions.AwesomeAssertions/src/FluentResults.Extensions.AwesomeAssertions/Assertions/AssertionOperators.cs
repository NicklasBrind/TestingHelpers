...
namespace FluentResults.Extensions.AwesomeAssertions
{
    ...
    internal class HaveReasonAssertionOperator
    {
            ...
            where TResult : ResultBase
        {
            ...
            return new AndWhichThatConstraint<TResultAssertion, TResult, ReasonAssertions>(parentConstraint, subject, new ReasonAssertions(subject.Reasons.SingleOrDefault(reason => messageComparison(reason.Message, expectedMessage)), AssertionChain.GetOrCreate()));
        }
    }
